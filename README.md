...
#### Get Single By Id
```php
$this->getSingleById("namatable", "field", "id");
```

Fungsinya buat ambil data yang kamu mau, SELECT * FROM table WHERE id tapi yang direturn cuma 1 data aja  
#### Get All By Id
```php
$this->getAllById("namatable", "field", "id");
```
...
#### Create specify
```php
createSpecify("activities", ["task_name", "userid"], ["'task_name'", "userid"]);
```
Ini beda dengan create biasa, jadi ini buat data dengan menentukan field yang lebih spesifik
dan ga ribet
