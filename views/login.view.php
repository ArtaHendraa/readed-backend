...
?>
    <div class="bg-white min-h-screen flex flex-col items-center justify-center">
        ...
        <main class="w-full max-w-xs text-center">
            <h1 class="font-fred text-3xl text-black mb-2 select-none" style="font-family: 'Fredericka the Great', cursive">
                Readed
            </h1>
            ...
            <form class="space-y-4" action="/login" method="POST" autocomplete="off">
                <div>
                    ...
                    <input type="text" id="username" name="username" placeholder="Username" value="<?= $value ?>"
                ...
                <div class="flex justify-between text-[10px] text-gray-600 mb-2">
                    <label class="flex items-center space-x-1">
                        <input type="checkbox" name="remember" class="w-3 h-3 border border-gray-400 rounded-sm" />
