...
{ ?>
    ...
    <div class="bg-white min-h-screen flex items-center justify-center px-4">
        ...
        <main class="w-full max-w-xs text-center">
            ...
            <h1 class="text-3xl text-black mb-2 select-none" style="font-family: 'Fredericka the Great', cursive">
                Readed
            </h1>
            ...
            <form class="space-y-4" method="POST">
                ...
                <label class="flex items-center space-x-1 text-[10px] text-gray-600 mb-2">
                    <input id="terms" name="terms" type="checkbox" class="w-3 h-3 border border-gray-400 rounded-sm"
                        required />
